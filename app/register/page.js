  ...
  return (
    <main style={{padding:40,fontFamily:"Arial"}}>
      ...
      <form style={{marginTop:20}}>
        <input placeholder="Nombre de la barbería" style={{display:"block",marginBottom:10,padding:10}} />
        <input placeholder="Email" style={{display:"block",marginBottom:10,padding:10}} />
        <input placeholder="Contraseña" type="password" style={{display:"block",marginBottom:10,padding:10}} />
